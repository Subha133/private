...
const PhoneIcon = () => (
  <svg
    ...
    aria-hidden="true"
  >
    <path d="M6.62 10.79a15.05 15.05 0 006.59 6.59l2.2-2.2a1 1 0 011.1-.27 11.72 11.72 0 004.59 1.11 1 1 0 011 1V21a1 1 0 01-1 1A16 16 0 013 6a1 1 0 011-1h3.5a1 1 0 011 1 11.72 11.72 0 001.11 4.59 1 1 0 01-.27 1.1l-2.22 2.2z" />
  </svg>
);
